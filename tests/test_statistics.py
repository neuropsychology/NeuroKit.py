...
def test_compute_dprime():
    ...
    nose.tools.eq_(np.round(parameters["bppd"], 2), -0.5)

def test_compute_BMI():
    nose.tools.eq_(round(nk.compute_BMI(182, 70, 27, "m")['BMI_old'], 2), 21.13)
