...
# ==============================================================================
# ==============================================================================
def ecg_process(ecg, rsp=None, sampling_rate=1000, filter_type="FIR", filter_band="bandpass", filter_frequency=[3, 45], segmenter="hamilton", quality_model="default", hrv_features=["RRi", "time", "frequency", "nonlinear"], age=None, sex=None, position=None):
    """
...
# ==============================================================================
# ==============================================================================
def ecg_hrv(rpeaks, sampling_rate=1000, hrv_features=["RRi", "time", "frequency", "nonlinear"]):
    """
    ...
    *See Also*
    ...
    if "RRi" in hrv_features:
        ...
        print("NeuroKit Warning: ecg_hrv(): 'RRi' not in hrv_features. Not computing anything.")
    return(hrv)
