...
- **Miscellaneous**
  - **[`complexity()`](http://neurokit.readthedocs.io/en/latest/documentation.html#complexity)**: Extract complexity/chaos indices, such as entropy, fractal dimensions, Hurst and Lyapunov exponents and more
